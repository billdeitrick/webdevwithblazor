...
public class BlogApiJsonDirectAccess: IBlogApi
{
    ...
    private void ManageDataPaths()
    {
        ...
        CreateDirectoryIfNotExists($@"{_settings.DataPath}{Path.DirectorySeparatorChar}{_settings.BlogPostsFolder}");
        CreateDirectoryIfNotExists($@"{_settings.DataPath}{Path.DirectorySeparatorChar}{_settings.CategoriesFolder}");
        CreateDirectoryIfNotExists($@"{_settings.DataPath}{Path.DirectorySeparatorChar}{_settings.TagsFolder}");
        CreateDirectoryIfNotExists($@"{_settings.DataPath}{Path.DirectorySeparatorChar}{_settings.CommentsFolder}");
    }
    ...
    private async Task<List<T>> LoadAsync<T>(string folder)
    {
        ...
        var list = new List<T>();
        foreach (var f in Directory.GetFiles($@"{_settings.DataPath}{Path.DirectorySeparatorChar}{folder}"))
        {
    ...
    private async Task SaveAsync<T>(string folder, string filename, T item)
    {
        ...
        var filepath = $@"{_settings.DataPath}{Path.DirectorySeparatorChar}{folder}{Path.DirectorySeparatorChar}{filename}.json";
